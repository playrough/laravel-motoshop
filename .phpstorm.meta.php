...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/ether/Coding/laravel-projects/motoshop/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/ether/Coding/laravel-projects/motoshop/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'password.confirm','frontend.home','frontend.home','frontend.xemay',
'frontend.xemay.phanloai','frontend.xemay.chitiet','frontend.lienhe','user.dangky','user.dangnhap',
'user.home','user.home','user.dathang','user.dathang','user.dathangthanhcong',
'user.donhang','user.donhang.chitiet','user.donhang.chitiet','user.hoso','user.hoso',
'user.doimatkhau','user.doimatkhau','user.dangxuat','admin.home','admin.home',
'admin.loaixe','admin.loaixe.them','admin.loaixe.them','admin.loaixe.sua','admin.loaixe.sua',
'admin.loaixe.xoa','admin.hangxe','admin.hangxe.them','admin.hangxe.them','admin.hangxe.sua',
'admin.hangxe.sua','admin.hangxe.xoa','admin.xemay','admin.xemay.them','admin.xemay.them',
'admin.xemay.sua','admin.xemay.sua','admin.xemay.xoa','admin.tinhtrang','admin.tinhtrang.them',
'admin.tinhtrang.them','admin.tinhtrang.sua','admin.tinhtrang.sua','admin.tinhtrang.xoa','admin.donhang',
'admin.donhang.them','admin.donhang.them','admin.donhang.sua','admin.donhang.sua','admin.donhang.xoa',
'admin.nguoidung','admin.nguoidung.them','admin.nguoidung.them','admin.nguoidung.sua','admin.nguoidung.sua',
'admin.nguoidung.xoa','storage.local',);
        registerArgumentsSet('views', 
'admin.home','auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset',
'auth.register','auth.verify','frontend.home','home','layouts.app',
'layouts.frontend','user.home','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
